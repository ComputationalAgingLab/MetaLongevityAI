...
class SummaryAnalysis:
    ...
    def filter_one(self, query: str, paper: Paper) -> bool:
        ...
        prompt += f"Is this paper a clinical study on the effects of {query} on human longevity? \n"
    ...
    def run(self, query: str, n: int = 20):
        ...
        orig_papers = self.source.search(f"({query}) AND (longevity) AND (RCT OR trial OR study) AND (human OR man OR woman)", n)
